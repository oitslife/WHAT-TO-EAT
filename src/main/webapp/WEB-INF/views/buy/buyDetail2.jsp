		...
		<c:forEach var="listDetail" items="${listDetail }">
			<div class="grid-container">
				...
				<div class="name_goods">
					...
					<span>${listDetail.item_contents }</span>
				</div>

				<div class="price_goods">
					<p>${listDetail.item_price }원</p>
...
sdadasdasdasdasdasdasd
				</div>
				
				
<!-- 
				<div class="btns_goods">

					<div class="explain">
						<a href="#explain.html">상품설명</a>
					</div>

					<div class="detail">
						<a href="#detail.html">상세정보</a>
					</div>

					<div class="review">
						<a href="#게시판주소욤^^https://localhost...">고객후기</a>
					</div>

					<div class="qna">
						<a href="#게시판주소욤^^https://localhost...">상품문의</a>
					</div>
					...
					<div class="tabmenu">
  <ul>
    <li id="tab1" class="btnCon"><a class="btn first" href="#tab1">상품설명</a>
    ...
    <li id="tab3" class="btnCon"><a class="btn" href="#tab3">고객후기</a>
...
<!-- <script>
	const buyInfo = {
				"item_id" : ${listDetail.item_id},
				"user_id" : ${sessionScope.member.user_id},
				"url"  	: ${contextPath}/buy/cartSave
			}
</script> -->

<%@ include file="/WEB-INF/views/buy/board_menu.jsp"%>
<script>
location.href = "#tab1";
